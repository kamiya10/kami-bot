        ...
        new SlashCommandSubcommandGroupBuilder()
            ...
            new SlashCommandSubcommandBuilder()
              ...
              .addChannelOption(
                new SlashCommandChannelOption()
                  ...
                  .setNameLocalizations(
                    $at("slash:voice.server.add.OPTIONS.channel.NAME")
                  )
                  .setDescription(
                    "The channel to be a temporary voice channel creator."
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.server.add.OPTIONS.channel.DESC")
                  )
              ...
              .addChannelOption(
                new SlashCommandChannelOption()
                  .setName("category")
                  .setNameLocalizations(
                    $at("slash:voice.server.add.OPTIONS.category.NAME")
                  )
                  .setDescription(
                    "The category temporary voice channel should be created in."
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.server.add.OPTIONS.category.DESC")
                  )
          ...
          .addSubcommand(
            new SlashCommandSubcommandBuilder()
              ...
              .setDescriptionLocalizations(
                $at("slash:voice.server.remove.DESC")
              )
              .addChannelOption(
                new SlashCommandChannelOption()
                  .setName("channel")
                  .setNameLocalizations(
                    $at("slash:voice.server.remove.OPTIONS.channel.NAME")
                  )
                  .setDescription(
                    "The channel to remove from being a temporary voice channel creator."
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.server.remove.OPTIONS.channel.DESC")
                  )
                  .addChannelTypes(ChannelType.GuildVoice)
                  .setRequired(true)
              )
            ...
            new SlashCommandSubcommandBuilder()
              ...
              .addChannelOption(
                new SlashCommandChannelOption()
                  .setName("channel")
                  .setNameLocalizations(
                    $at("slash:voice.server.info.OPTIONS.channel.NAME")
                  )
                  .setDescription(
                    "Show the specific temporary voice channel creator configuration."
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.server.info.OPTIONS.channel.DESC")
                  )
                  .addChannelTypes(ChannelType.GuildVoice)
              )
          )
          ...
          .addSubcommand(
            new SlashCommandSubcommandBuilder()
              ...
              .setDescription(
                "Change the name of the template temporary voice channel."
              )
              ...
              .addStringOption(
                new SlashCommandStringOption()
                  .setName("name")
                  .setNameLocalizations(
                    $at("slash:voice.name.OPTIONS.name.NAME")
                  )
                  .setDescription(
                    "The new name of the temporary voice channel."
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.name.OPTIONS.name.DESC")
                  )
              )
              .addChannelOption(
                new SlashCommandChannelOption()
                  .setName("channel")
                  .setNameLocalizations(
                    $at("slash:voice.server.OPTIONS.default.NAME")
                  )
                  .setDescription(
                    "Make this setting only affects the specified channel creator."
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.server.OPTIONS.default.DESC")
                  )
                  .addChannelTypes(ChannelType.GuildVoice)
              )
              .addBooleanOption(
                new SlashCommandBooleanOption()
                  .setName("override")
                  .setNameLocalizations(
                    $at("slash:voice.server.OPTIONS.override.NAME")
                  )
                  .setDescription("Override user preferences.")
                  .setDescriptionLocalizations(
                    $at("slash:voice.server.OPTIONS.override.DESC")
                  )
              )
          )
          // /voice server limit
          .addSubcommand(
            new SlashCommandSubcommandBuilder()
              ...
              .setDescription(
                "Change the user limit of the template temporary voice channel."
              )
              ...
              .addIntegerOption(
                new SlashCommandIntegerOption()
                  .setName("limit")
                  .setNameLocalizations(
                    $at("slash:voice.limit.OPTIONS.limit.NAME")
                  )
                  .setDescription(
                    "The new user limit of the temporary voice channel. (0 = Unlimited)"
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.limit.OPTIONS.limit.DESC")
                  )
                  .setMinValue(0)
                  .setMaxValue(99)
              )
          ...
          .addSubcommand(
            new SlashCommandSubcommandBuilder()
              .setName("bitrate")
              .setNameLocalizations(
                $at("slash:voice.bitrate.OPTIONS.bitrate.NAME")
              )
              .setDescription(
                "Change the bitrate of the template temporary voice channel."
              )
              .setDescriptionLocalizations(
                $at("slash:voice.server.bitrate.DESC")
              )
              .addIntegerOption(
                new SlashCommandIntegerOption()
                  .setName("bitrate")
                  ...
                  .setDescriptionLocalizations(
                    $at("slash:voice.bitrate.OPTIONS.bitrate.DESC")
                  )
                  .setMinValue(8)
                  .setMaxValue(384)
              )
          ...
          .addSubcommand(
            new SlashCommandSubcommandBuilder()
              .setName("region")
              .setNameLocalizations(
                $at("slash:voice.region.OPTIONS.region.NAME")
              )
              .setDescription(
                "Change the region of the template temporary voice channel."
              )
              .setDescriptionLocalizations(
                $at("slash:voice.server.region.DESC")
              )
              .addStringOption(
                new SlashCommandStringOption()
                  .setName("region")
                  ...
                  .setDescription(
                    "The new region of the temporary voice channel."
                  )
                  .setDescriptionLocalizations(
                    $at("slash:voice.region.OPTIONS.region.DESC")
                  )
        ...
        new SlashCommandSubcommandBuilder()
          ...
          .addBooleanOption(
            new SlashCommandBooleanOption()
              ...
              .setDescriptionLocalizations(
                $at("slash:voice.OPTIONS.default.DESC")
              )
          )
          .addBooleanOption(
            new SlashCommandBooleanOption()
              ...
              .setDescriptionLocalizations(
                $at("slash:voice.OPTIONS.global.DESC")
              )
          )
      )
      // /voice limit
        ...
        new SlashCommandSubcommandBuilder()
          ...
          .addStringOption(
            new SlashCommandStringOption()
              ...
              .setDescriptionLocalizations(
                $at("slash:voice.clear.OPTIONS.which.DESC")
              )
    ...
    async execute(interaction) {
      try {
        ...
        if (interaction.options.getSubcommandGroup(false)) {
          ...
          const guildVoiceData = client.database.guild(
          ...
          const userVoiceData = client.database.user(
          ...
          const memberIsInTrackedVoiceChannel =
            ...
            client.states.voice.has(interaction.member.voice.channel.id);
          ...
          switch (subcommand) {
            ...
            case "name": {
              ...
              if (setAsDefault) {
                ...
                const channel = client.states.voice.get(
            ...
            case "clear": {
              ...
              switch (scope) {
                ...
                case "all": {
                  client.database.user(interaction.member.id).voice = {};
