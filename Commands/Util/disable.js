...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(
      new SlashCommandSubcommandBuilder()
        ...
        .setDescription(
          "Send the original message aside when you mentioned it by URL.",
        )
        ...
        .addBooleanOption(
          new SlashCommandBooleanOption()
            ...
            .setDescription(
              "If true, the bot will try to fetch the original message and reply aside of your URL.",
            )
            .setDescriptionLocalization(
              "zh-TW",
              "如果為 true ，機器人將會偵測你的訊息是否含有訊息連結，並嘗試傳送原始訊息到你的訊息下方。",
            )
            .setRequired(true),
        ),
    )
      ...
      new SlashCommandSubcommandBuilder()
        ...
        .addBooleanOption(
          new SlashCommandBooleanOption()
            ...
            .setDescription(
              "If true, people can transform your messages into quotes.",
            )
            .setDescriptionLocalization(
              "zh-TW",
              "如果為 true ，其他人可以把你的訊息變成名言。",
            )
            .setRequired(true),
        ),
    ),
  ...
  async execute(interaction) {
    ...
    let UserSettings = interaction.client.database.UserDatabase.get(
      interaction.user.id,
    );
